...
class LinearRegressor:
    ...
    def fit_multiple(self, X, y):
        ...
        self.intercept = betha[0]
        self.coefficients = betha[1:]
    ...
    def fit_gradient_descent(self, X, y, learning_rate=0.01, iterations=1000):
        ...
        for epoch in range(iterations):            
            ...
            self.theta_history.append([self.coefficients[0], self.intercept])

            if epoch % 1000 == 0:
                mse = (1/m) * sum((predictions - y)**2)
...
def one_hot_encode(X, categorical_indices, drop_first=False):
    ...
    for index in sorted(categorical_indices, reverse=True):
        ...
        one_hot = (categorical_column[:, None] == unique_values[None, :]).astype(int)
        ...
        X_transformed = np.concatenate([left, one_hot, right], axis=1)
